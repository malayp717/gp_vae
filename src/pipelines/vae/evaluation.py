"""Evaluation runners for VAE-family models."""
...
def run_validation(
    ...
    image_metrics = compute_image_metrics(model, loader, device, num_fid_samples=config.get("logging", {}).get("num_fid_samples", 1024))
